...
<body>
    ...
    <table class="mt-2 mx-auto table-sm w-25 text-left">
        @foreach ($repositories as $repository)
            <tr class="accordion-item">
                <th scope="col" class="accordion-header align-middle border" id="headingOne">
                    <div class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="{{ '#' . $repository->name }}" aria-expanded="true" aria-controls="collapseOne">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" style="width: 1rem" class="mb-1">
                ...
                <td class="d-flex justify-content-center border"><svg xmlns="http://www.w3.org/2000/svg" fill="gold"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 1rem">
            ...
            <tr>
                <td>
                    <div id="{{ $repository->name }}" class="accordion-collapse collapse" aria-labelledby="headingOne"
